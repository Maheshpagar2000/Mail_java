...
public class MailHandlerBase {
    ...
    public void sendMail()
    {
        ...
        try {
            ...
            mailMessage.setSubject("Mahesh Mailing to freinds");
            mailMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("xxxxxxxxx@gmail.com"));
            mailMessage.setText("Mahesh is mailing through the java");
